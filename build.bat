...
set ext=user32.lib gdi32.lib shell32.lib ws2_32.lib ole32.lib %VULKAN_SDK%/lib/vulkan-1.lib %peak%/src/stb_vorbis.c
where /q cl && (
...
set inc=-I%VULKAN_SDK%/include -I%peak%/src
set ext=-L%VULKAN_SDK%/lib -lgdi32 -lws2_32 -lole32 -lvulkan-1 %peak%/src/stb_vorbis.c
where /q g++ && (
